...
!function(e, t) {
    ...
    function d(e, t, n=!1) {
        ...
        if (r && r.modifiers.includes("transition")) {
            ...
            i.filter(e=>["enter", "enter-start", "enter-end"].includes(e.value)).length > 0 ? function(e, t, n) {
    ...
    function f(e, t, n=!1) {
        ...
        if (r && r.modifiers.includes("transition")) {
            ...
            i.filter(e=>["leave", "leave-start", "leave-end"].includes(e.value)).length > 0 ? function(e, t, n) {
        ...
        const s = e.style.opacity
            ...
            during() {
                u && (e.style.transformOrigin = r.origin),
                    e.style.transitionProperty = [c ? "opacity" : "", u ? "transform" : ""].join(" ").trim(),
    ...
    function y(e, t, i, r, s) {
        ...
        o.forEach((i,u)=>{
                ...
                p ? (delete p.__x_for_key,
                    p.__x_for = f,
                    e.updateElements(p, ()=>p.__x_for)) : (d(p = function(e, t) {
    ...
    function g(e, t, n, r, s, a) {
        ...
        if ("value" === n)
            if (void 0 === o && r.match(/\./).length && (o = ""),
            "radio" === t.type)
                void 0 === t.attributes.value && "bind" === a ? t.value = o : "bind" !== a && (t.checked = t.value == o);
            ...
            [null, void 0, !1].includes(o) ? t.removeAttribute(n) : !function(e) {
    ...
    function x(e, t, n, i, r, a={}) {
        if (i.includes("away")) {
            let s = o=>{
                    t.contains(o.target) || t.offsetWidth < 1 && t.offsetHeight < 1 || (w(e, r, o, a),
                        ...
                        if (!(function(e) {
                            ...
                            i.length > 0) {
                                const t = i.filter(t=>("cmd" !== t && "super" !== t || (t = "meta"),
                                    e[`${t}Key`]));
                                if (t.length === i.length && n[0] === _(e.key))
                                    return !1
                            }
                            return !0
        ...
        return "radio" === e.type && (e.hasAttribute("name") || e.setAttribute("name", n)),
            (n,i)=>{
                if (n instanceof CustomEvent && n.detail)
                    return n.detail;
                if ("checkbox" === e.type)
                    return Array.isArray(i) ? n.target.checked ? i.concat([n.target.value]) : i.filter(e=>e !== n.target.value) : n.target.checked;
    ...
    class K {
        ...
        getOwnPropertyDescriptor(e, t) {
            ...
            if (F(s))
                return s;
            const a = D(e, t);
            return F(a) ? ((s = ee(i, s, q)).configurable || S(e, t, s),
                s) : a
        }
        preventExtensions(e) {
        ...
        defineProperty(e, t, n) {
            ...
            return S(i, t, function(e) {
                return N.call(e, "value") && (e.value = U(e.value)),
                    e
            }(n)),
            !1 === a && S(e, t, ee(r, n, q)),
                s(i, t),
    ...
    function Z(e) {
        let t = void 0;
        return O(e) ? t = [] : "object" == typeof e && (t = {}),
            t
    }
    ...
    class ne {
        constructor(e, t=null) {
            ...
            let {membrane: s, data: o} = this.wrapDataInObservable(this.unobservedData);
            var l;
            this.$data = o,
                this.membrane = s,
        ...
        initializeElement(e, t) {
            e.hasAttribute("class") && c(e).length > 0 && (e.__x_original_classes = e.getAttribute("class").split(" ")),
            ...
            i.forEach(({type: r, value: s, modifiers: a, expression: o})=>{
                    switch (r) {
                        ...
                        case "show":
                            ...
                            break;
                        case "if":
                            if (i.filter(e=>"for" === e.type).length > 0)
                                return;
                            l = this.evaluateReturnExpression(e, o, n);
                            !function(e, t, n, i, r) {
